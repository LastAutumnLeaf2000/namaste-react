...
const Cart = () => {
  ...
  const handleDeleteItem = (item) =>{
    ...
    return (
      <>
      <div className="heading text-center font-semibold text-4xl mt-5 mb-2">My Cart</div>
      
        {
          cartItems.length== 0 ? (<h1 className="heading text-center font-semibold text-3xl mt-20 mb-2">Cart is Empty!</h1>) : (<button
        ...
        <div className="menu-container w-6/12 m-auto">
